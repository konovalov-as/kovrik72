...
import {compileStyles, compileMinStyles, compileCriticalStyles} from './gulp/compileStyles.mjs';
...
const build = gulp.series(clean, copy, sprite, gulp.parallel(compileCriticalStyles, compileMinStyles, compileScripts, pug));
const dev = gulp.series(clean, copy, sprite, gulp.parallel(compileCriticalStyles, compileMinStyles, compileScripts, pug, optimizePng, optimizeJpg, optimizeSvg), syncServer);
const start = gulp.series(clean, copy, sprite, gulp.parallel(compileCriticalStyles, compileStyles, compileScripts, pug), syncServer);
const nomin = gulp.series(clean, copy, sprite, gulp.parallel(compileCriticalStyles, compileStyles, compileScripts, pug, optimizePng, optimizeJpg, optimizeSvg));
